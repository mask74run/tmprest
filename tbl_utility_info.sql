...
ALTER TABLE utility_info OWNER TO itsm;
GRANT ALL ON TABLE utility_info TO itsm;
GRANT UPDATE, INSERT, SELECT, DELETE ON TABLE utility_info TO itsmapp;
GRANT UPDATE, INSERT, SELECT, DELETE ON TABLE utility_info TO rl_gitsm_all;
GRANT SELECT ON TABLE utility_info TO rl_gitsm_sel;