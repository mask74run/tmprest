...
-- DROP TABLE itsm.jsa_rule;

CREATE TABLE itsm.jsa_rule (
...
ALTER TABLE itsm.jsa_rule OWNER TO itsm;
GRANT ALL ON TABLE itsm.jsa_rule TO itsm;
GRANT SELECT, UPDATE, DELETE, INSERT ON TABLE itsm.jsa_rule TO itsmapp;
GRANT SELECT, UPDATE, DELETE, INSERT ON TABLE itsm.jsa_rule TO rl_gitsm_all;
GRANT SELECT ON TABLE itsm.jsa_rule TO rl_gitsm_sel;