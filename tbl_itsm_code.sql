...
ALTER TABLE itsm.itsm_code OWNER TO itsm;
GRANT ALL ON TABLE itsm.itsm_code TO itsm;
GRANT SELECT, UPDATE, DELETE, INSERT ON TABLE itsm.itsm_code TO itsmapp;
GRANT SELECT, UPDATE, DELETE, INSERT ON TABLE itsm.itsm_code TO rl_gitsm_all;
GRANT SELECT ON TABLE itsm.itsm_code TO rl_gitsm_sel;